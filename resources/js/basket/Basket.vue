    ...
    <div>
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 form-group">
                        <button type="submit" @click="submit" style="width: 100%;color:white" class="btn btn-lg btn-primary btn-block">Book now!</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="d-flex justify-content-between">
                    ...
                    <h6 class="badge badge-secondary text-uppercase" style="color:black">
